...
{
    public partial class ManagerFlatFinencial : Form
    {
        private string userName;
        private int userId;
        private Dictionary<string, int> flatDesignationToIdMap = new Dictionary<string, int>();

        public ManagerFlatFinencial(string username)
        {
            InitializeComponent();
        ...
        {
            string query = "SELECT house_id FROM ManagerHouseTable WHERE manager_id = @ManagerId";
        ...
        private void managerflatfinencialsbackbutton_Click(object sender, EventArgs e)
        {
        ...
        private void ManagerFlatFinencial_Load(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsChooseHouseComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            int houseId = int.Parse(ownerFlatFinencialsChooseHouseComboBox.SelectedItem.ToString());
            PopulateFlatComboBox(houseId);
        }

        private void managerFlatFinencialsChooseFlatComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void managerFlatFinencialsUnitRateTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsMeterReadingTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsServiceChargeTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsRentTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsCleaningChargeTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsWaterBillTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsGasBillTextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void managerFlatFinencialsMiscellaneousTextBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void managerFlatFinencialsNextbutton_Click(object sender, EventArgs e)
        {
            UpdateFinancialFields();
        ...
        {
            if (ownerFlatFinencialsChooseHouseComboBox.SelectedItem != null)
            {
                int houseId = int.Parse(ownerFlatFinencialsChooseHouseComboBox.SelectedItem.ToString());
                PopulateFlatComboBox(houseId);
            }
